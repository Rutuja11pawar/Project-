<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminCancelSearch.aspx.cs" Inherits="AdminCancelSearch" %>
         ...
         <table class="style1" border="2" style="font-size: 20px; height: 500px;  width:500px;" >
            <tr>
                <td align="center" class="style2">
                   Date</td>
                <td align="center">
                    <asp:TextBox ID="date" runat="server" Height="25px" type="date"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    <asp:Button ID="Button1" runat="server" Height="32px" Text="Search" 
